...
function Navbare(){
    ...
    return(
        ...
        <nav className=' xl:mt-5 lg:mt-5 md:mt-5 flex items-center justify-center sm:h-20 mx-auto md:w-1/6 xl:w-1/6  lg:w-1/6 sm:mt-5  '>
            
            <div className=' absolute shadow-2xl nav flex-1  items-center h-20 mt-5 fixed flex justify-center sm:h-20 md:h-20 lg:h-20 sm:mt-0  sm:w-full md:w-auto lg:w-auto xl:w-auto sm:pb-1'>
